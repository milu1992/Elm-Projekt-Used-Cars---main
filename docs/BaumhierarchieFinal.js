...
var $author$project$Entwicklung$ElmBaumHierarchi$GotFlare = function (a) {
	return {$: 'GotFlare', a: a};
};
...
function $author$project$Entwicklung$ElmBaumHierarchi$cyclic$treeDecoder() {
	return A3(
		$elm$json$Json$Decode$map2,
		F2(
			function (name, children) {
				if (children.$ === 'Nothing') {
					return A2($alex_tan$elm_tree_diagram$TreeDiagram$node, name, _List_Nil);
				} else {
					var c = children.a;
					return A2($alex_tan$elm_tree_diagram$TreeDiagram$node, name, c);
				}
			}),
		A2(
			...
			A2(
				...
				$elm$json$Json$Decode$list(
					$elm$json$Json$Decode$lazy(
						function (_v1) {
							return $author$project$Entwicklung$ElmBaumHierarchi$cyclic$treeDecoder();
						})))));
}
try {
	var $author$project$Entwicklung$ElmBaumHierarchi$treeDecoder = $author$project$Entwicklung$ElmBaumHierarchi$cyclic$treeDecoder();
	$author$project$Entwicklung$ElmBaumHierarchi$cyclic$treeDecoder = function () {
		return $author$project$Entwicklung$ElmBaumHierarchi$treeDecoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `Entwicklung.ElmBaumHierarchi` are causing infinite recursion:\n\n  ┌─────┐\n  │    treeDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Entwicklung$ElmBaumHierarchi$init = function (_v0) {
	return _Utils_Tuple2(
		{
			errorMsg: 'Loading ...',
			tree: A2($alex_tan$elm_tree_diagram$TreeDiagram$node, '', _List_Nil)
		},
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Entwicklung$ElmBaumHierarchi$GotFlare, $author$project$Entwicklung$ElmBaumHierarchi$treeDecoder),
				url: 'https://raw.githubusercontent.com/milu1992/Elm-Projekt-Used-Cars---main/master/Data/AufbereiteteDaten/LocationCar.json'
			}));
};
...
var $author$project$Entwicklung$ElmBaumHierarchi$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var newTree = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{errorMsg: 'No Error', tree: newTree}),
...
var $author$project$Entwicklung$ElmBaumHierarchi$drawLine = function (_v0) {
	var targetX = _v0.a;
	var targetY = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$x2(targetX),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$y2(targetY),
...
var $author$project$Entwicklung$ElmBaumHierarchi$drawNode = function (n) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$r(16),
						$elm_community$typed_svg$TypedSvg$Attributes$stroke(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, 0.5, 17),
								A3($elm_community$typed_svg$TypedSvg$Types$Rotate, 90.0, 0.0, 0.0)
							])),
...
var $author$project$Entwicklung$ElmBaumHierarchi$TreeLayout = F5(
	function (orientation, levelHeight, subtreeDistance, siblingDistance, padding) {
		return {levelHeight: levelHeight, orientation: orientation, padding: padding, siblingDistance: siblingDistance, subtreeDistance: subtreeDistance};
	});
var $alex_tan$elm_tree_diagram$TreeDiagram$TopToBottom = {$: 'TopToBottom'};
var $alex_tan$elm_tree_diagram$TreeDiagram$topToBottom = $alex_tan$elm_tree_diagram$TreeDiagram$TopToBottom;
var $author$project$Entwicklung$ElmBaumHierarchi$tLayout = A5($author$project$Entwicklung$ElmBaumHierarchi$TreeLayout, $alex_tan$elm_tree_diagram$TreeDiagram$topToBottom, 250, 200, 60, 300);
var $author$project$Entwicklung$ElmBaumHierarchi$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A4($alex_tan$elm_tree_diagram$TreeDiagram$Svg$draw, $author$project$Entwicklung$ElmBaumHierarchi$tLayout, $author$project$Entwicklung$ElmBaumHierarchi$drawNode, $author$project$Entwicklung$ElmBaumHierarchi$drawLine, model.tree)
			]));
};
var $author$project$Entwicklung$ElmBaumHierarchi$main = $elm$browser$Browser$element(
	{
		init: $author$project$Entwicklung$ElmBaumHierarchi$init,
		subscriptions: function (m) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Entwicklung$ElmBaumHierarchi$update,
		view: $author$project$Entwicklung$ElmBaumHierarchi$view
	});
_Platform_export({'Entwicklung':{'ElmBaumHierarchi':{'init':$author$project$Entwicklung$ElmBaumHierarchi$main(
